...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    NO_ARNG, NO_QUOT, KC_N,    KC_M,    KC_COMM, KC_DOT,  NO_MINS, KC_RSFT,
                                   KC_LALT,   TG(4), MO(5),   KC_SPC,  KC_ENT,  KC_BSPC, MO(6),   KC_LGUI
    ),
    [5] = LAYOUT(
...
// Shit needs its own thing. Use different function names to avoid conflicts with keyboard-level functions
